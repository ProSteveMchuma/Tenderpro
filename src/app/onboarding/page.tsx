...
export default function OnboardingPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">Onboarding</p>
      <h1 className="mt-2 text-3xl font-semibold">Set up your company workspace</h1>
      <p className="mt-2 text-sm text-muted-foreground">Step {step} of 4</p>
      <form action={completeOnboardingAction} className="mt-8 rounded-xl border bg-background p-6">
        {step === 1 ? (
          <div>
            ...
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              ...
              <Field label="Country">
                <select name="country" defaultValue="KE" className="h-9 w-full rounded-lg border px-3 text-sm">
              ...
              <Field label="Currency">
                <select name="currency" defaultValue="KES" className="h-9 w-full rounded-lg border px-3 text-sm">
        ...
        {step === 2 ? (
          <div>
            ...
            <select name="businessType" className="mt-4 h-9 w-full rounded-lg border px-3 text-sm">
